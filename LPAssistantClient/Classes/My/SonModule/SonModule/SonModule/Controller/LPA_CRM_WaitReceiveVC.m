...
@interface LPA_CRM_WaitReceiveVC ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation LPA_CRM_WaitReceiveVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell.cancelBtn setTitle:@"查看物流" forState:UIControlStateNormal];
    [cell.cancelBtn addTarget:self action:@selector(watchLogistics) forControlEvents:UIControlEventTouchUpInside];
    [cell.goToPayBtn setTitle:@"确认收货" forState:UIControlStateNormal];
    return cell;
}
